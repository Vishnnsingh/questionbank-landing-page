...
export function Pricing() {
  return (
    <section className="relative py-20 lg:py-32 bg-gradient-to-br from-slate-50 via-teal-50 to-blue-50 overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="grid gap-12 lg:grid-cols-2 max-w-5xl mx-auto">
          {plans.map((plan, index) => (
            <motion.div
              ...
              className={`relative bg-white/80 backdrop-blur-sm rounded-3xl p-6 lg:p-8 border-2 transition-all duration-500 ${
                plan.popular
            ...
            >
              ...
              <div className="text-center mb-6">
                ...
                <div className="flex items-baseline justify-center gap-2 mb-1">
                  <span className="text-4xl lg:text-5xl bg-gradient-to-r from-blue-600 to-teal-600 bg-clip-text text-transparent">
                    ₹{plan.price}
                  </span>
        ...
        <div className="mt-16 text-center">
          <div className="inline-flex items-center gap-8 bg-white/80 backdrop-blur-sm rounded-2xl px-8 py-4 shadow-lg border border-slate-200/50">
