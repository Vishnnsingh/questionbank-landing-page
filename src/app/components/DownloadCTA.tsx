...
export function DownloadCTA() {
  return (
    <section className="relative py-20 lg:py-32 bg-gradient-to-br from-blue-600 via-teal-500 to-teal-600 overflow-hidden">
      {/* Background Pattern */}
      ...
      <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto">
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            <button className="inline-flex items-center gap-3 bg-white text-blue-600 px-8 py-4 rounded-xl shadow-lg hover:shadow-xl hover:scale-105 transition-all">
            ...
            <button className="inline-flex items-center gap-3 bg-white/10 backdrop-blur-sm border border-white/20 text-white px-8 py-4 rounded-xl hover:bg-white/20 transition-all">
          ...
          <div className="mt-10 flex items-center justify-center gap-8 text-sm text-teal-50">
